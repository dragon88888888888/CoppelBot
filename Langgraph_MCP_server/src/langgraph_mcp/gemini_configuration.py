...
class GeminiConfiguration:
    """Configuration class for MCP routing operations with Gemini."""

    embedding_model: Annotated[str, {"__template_metadata__": {"kind": "embeddings"}}] = field(
        default="google/models/text-embedding-004",
        metadata={"description": "Embedding model to use."}
    )

    retriever_provider: Annotated[Literal["chroma"], {"__template_metadata__": {"kind": "retriever"}}] = field(
        default="chroma",
    ...
    def from_runnable_config(
        ...
        """Create a GeminiConfiguration instance from a RunnableConfig object.
        ...
        Returns:
            T: An instance of GeminiConfiguration with the specified configuration.
        """
...
T = TypeVar("T", bound=GeminiConfiguration)